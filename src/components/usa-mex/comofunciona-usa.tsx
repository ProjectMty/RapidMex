            ...
            <div className="grid 2xl:grid-cols-4 h-full xl:h-[50%]">
                <div className="col-start-2 col-span-2">
                    ...
                    <div className="grid xl:grid-cols-2">
                        <div className="">
                            <h2 className=" text-black   text-center px-1  mx-auto col-span-2">
                                <LeftAnimation
                                    delay={0.8}
                                    lines={[
                            ...
                            <div className="flex ">
                                ...
                                <div className="pl-2 font-semibold text-[15px] 3xl:w-[80%]
                                        sm:text-[20px]
                                        lg:text-[20px]
                                        2xl:text-[25px]">
                                    <DownAnimation
