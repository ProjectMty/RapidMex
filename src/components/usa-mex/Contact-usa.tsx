      ...
      case 1:
        if (!formData.name || !formData.phone || !formData.email || !formData.subject) {
          Swal.fire({
            ...
            text: "You must fill in all fields to continue",
            icon: "warning",
            timer: 3000,
          });
          return;
        ...
        if (formData.name.length < 5) {
          Swal.fire({
            ...
            text: "First and last name must have at least 5 characters",
            icon: "warning",
            timer: 3000,
          });
          return;
        ...
        if (formData.phone.length < 14) {
          Swal.fire({
            ...
            text: "The phone number entered is not valid",
            icon: "warning",
            timer: 3000,
          });
          return;
        ...
        if (!validarCorreo(formData.email)) {
          Swal.fire({
            title: "Invalid Email",
            text: "The email address entered is not in a valid format",
            icon: "warning",
            timer: 3000,
          });
          return;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (errorForm.cpDestino || errorForm.cpOrigen) {
      Swal.fire({
        ...
        text: "The postal code entered is not valid",
        icon: "warning",
        timer: 3000,
      });
      return;
    ...
    if (response.ok) {
      ...
      Swal.fire({
        title: "Error",
        text: "There was an error sending the contact information. Please try again later.",
        icon: "error"
      });
      return;
    }
            ...
            >
              ...
              {paso === 2 && (
                <div className="lg:grid  md:grid-cols-2 gap-4">
                  <h3 className="text-lg font-semibold col-span-2 text-center">Package Information</h3>
              ...
              {paso === 3 && (
                <div className="lg:grid  lg:grid-cols-2 gap-4">
                  <h3 className="text-lg font-semibold col-span-2 text-center">Shipping Information</h3>
                  <div className="relative">
                    <label htmlFor="">Origin ZIP Code</label>
