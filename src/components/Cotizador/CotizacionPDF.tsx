      ...
      <Page style={styles.page}>
        ...
        {datos.origen1 ? (
          <View style={styles.section}>
            ...
            <Text style={styles.value}>Colonia: {datos.origen1.colonia ?? "N/A"} </Text>
            <Text style={styles.value}>Calle: {datos.origen1.calle} </Text>
        ...
        {datos.destino1 ? (
          <View style={styles.section}>
            ...
            <Text style={styles.value}>Colonia: {datos.destino1.colonia ?? "N/A"} </Text>
            <Text style={styles.value}>Calle: {datos.destino1.calle} </Text>
        ...
        {datos.origen2 ? (
          <View style={styles.section}>
            ...
            <Text style={styles.value}>Colonia: {datos.origen2.colonia ?? "N/A"} </Text>
            <Text style={styles.value}>Calle: {datos.origen2.calle} </Text>
        ...
        {datos.destino2 ? (
          <View style={styles.section}>
            ...
            <Text style={styles.value}>Colonia: {datos.destino2.colonia ?? "N/A"} </Text>
            <Text style={styles.value}>Calle: {datos.destino2.calle} </Text>
        ...
        {datos.origen3 ? (
          <View style={styles.section}>
            ...
            <Text style={styles.value}>Colonia: {datos.origen3.colonia ?? "N/A"} </Text>
            <Text style={styles.value}>Calle: {datos.origen3.calle} </Text>
        ...
        {datos.destino3 ? (
          <View style={styles.section}>
            ...
            <Text style={styles.value}>Colonia: {datos.destino3.colonia ?? "N/A"} </Text>
            <Text style={styles.value}>Calle: {datos.destino3.calle} </Text>
